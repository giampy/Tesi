...
Sebbene in alcuni casi sia possibile (ed \`e stato fatto~\cite{Shannon}) provare dei risultati \emph{incondizionatamente} la maggior parte delle prove di teoremi nel campo 
