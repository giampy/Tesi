...
Prima di procedere \`e bene precisare che l'espressione: \emph{per $k=i$ CryptoVerif riesca a dimostrare l'asserto}\footnote{Che \`e l'ipotesi induttiva che verr\`a sfruttata.}
