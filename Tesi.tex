...
e assegna a questa il valore di $M$. Il costrutto definito dalla produzione: $$ Il costrutto $let$ $p=M$ $in$ $M'$ $else$ $M''$ cerca di decomporre il termine $M$ secondo il pattern $p$. In caso di successo ritorna
il valore di $M'$ altrimenti ritorna il valor di $M''$.
