...
che il risultato di questa iterazione \`e comunque pseudocasuale. La tecnica ibrida in questione consiste nel considerare p'(n) distribuzioni generate
dall'output di un ipotetico algoritmo G in cui...\\ \\ \\ \\ 
